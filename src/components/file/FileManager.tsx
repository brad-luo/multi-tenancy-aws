  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div>
          ...
          <Button
            ...
            disabled={uploading || !canAddFile(files?.length || 0)}
          >
      ...
      {UI_CONFIG.SHOW_LIMITS.FILE_COUNT && (
        <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg dark:text-white dark:bg-gray-600">
          <p className="text-blue-800 text-sm dark:text-white">
            Files: {files?.length || 0}/{LIMITS.FILES_PER_PROJECT} • Max size: {LIMITS.MAX_FILE_SIZE_MB}MB per file
          </p>
        </div>
      )}

      {!canAddFile(files?.length || 0) && (
